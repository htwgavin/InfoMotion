...
namespace SwipeMenu
{
	...
	public class Menu : MonoBehaviour
	{
		...
		public float _centreOffset = 1.0f;
		public float _currentMenuPosition = 0.0f;
		public float _maxMenuPosition;
        ...
        public float _EndeVomMenu= 3.0f;
        public float _switchProKlick = 1.0f;

        public float _anfangVomMenu = 0.5f;
        ...
        private void UpdateMenuItemsPositionInWorldSpace ()
		{
			for (int i = 0; i < menuItems.Length; i++) {
				...
				Vector3 pos = new Vector3 (posx, yPos, posz);
